...
//     if(error) console.log(error);
    ...
    //                 "Van", "The ice Breaker","Liquor Store","Modern Japan",
    //                 ],
    //         Mediums: "Digital Art",
    ...
    //         Mediums: "Ink",
    //         Image:[
    //             "https://i.imgur.com/ErnA3FG.jpg",
    //             "https://i.imgur.com/l42fKzR.jpg",
    //             "https://i.imgur.com/UiNIvCU.jpg",
...
>>>>>>> 433e0fd4495dfb4da4bb4d2277c1426300cf5d9c

router.get('/', async(req, res)=>{
    try{
        const artwork = await ArtWork.find()
        const context = {artwork}
        return res.render('artwork/index.ejs',context)
    }
    catch(error){
...
router.get('/', (req, res)=>{
  ArtWork.find({}, (error, foundArtWork)=>{
    ...
    console.log('============');
    console.log(context);
    res.render('artwork/index.ejs',context);
    });
});
=======
>>>>>>> development
...
router.get('/:artworkId', (req, res) => {
    ArtWork.findById(req.params.artworkId, (error, foundArtWork) => {
        ...
        console.log(foundArtWork)
        return res.render('artwork/show.ejs', {artworks: foundArtWork});
    });
